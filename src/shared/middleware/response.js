...
/**
 * Attaches standard response helpers so controllers send a consistent envelope
 * (rules/03). When ENCRYPTION_ENABLED, the `data` payload is encrypted and sent
 * as `{ ..., encrypted }` (rules/05).
 */
